      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Center(
              child: GradientText('Son actualmente las... \n${DateTime.now().hour.toString()}:${DateTime.now().minute.toString()}', gradient: LinearGradient(
                  colors: [Colors.blue.shade500, Colors.purple.shade900]),
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 30,),align: TextAlign.center ),
            ),
